...
class RandomDrawerTest extends Specification {
    ...
    def "should generate GiverReceiver aggregator for 3 persons"() {
        ...
        def drawer = new RandomDrawer(model, new Random(2));
    ...
    def "draw should be able to be interrupted if cannot get solution"() {
        ...
        def unfinishedRunnables = executor.shutdownNow()
        feature.get()

        then:
        !unfinishedRunnables.isEmpty()
